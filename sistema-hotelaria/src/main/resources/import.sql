...
INSERT INTO Cliente (id, nome, cpf, fone) VALUES
                                            (1,'Bruno', 65412332155, 62984322341),
                                            (2,'Lysa', 07864187233, 61972320411),
                                            (3,'Camila', 42311508912, 63972320978),
                                            (4,'Leonardo', 77908956421,51984322425),
                                            (5,'Jerod', 02341567812, 60984238912),
                                            (6,'Brayan', 21476890432, 72984543290),
                                            (7,'Bruna', 56475432177, 68984543211),
                                            (8,'Leticia', 09002430211, 32984567821),
                                            (9,'Frederico', 06172342155, 54984215269),
                                            (10,'Fabiana', 45169289077, 63984526790);
